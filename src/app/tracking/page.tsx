...
import { mockPackages, mockTrackingUpdates } from '@/lib/supabase';

export default function TrackingPage() {
  const [trackingNumber, setTrackingNumber] = useState('BB-2026-157946183');
  const [isLoading, setIsLoading] = useState(false);
  const [selectedPackage, setSelectedPackage] = useState(mockPackages[0]);
  const [trackingHistory, setTrackingHistory] = useState(mockTrackingUpdates['1']);
  ...
  const handleTrack = async (e: React.FormEvent) => {
    ...
    if (foundPackage) {
      ...
      setTrackingHistory(mockTrackingUpdates[foundPackage.id] || []);
    }
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            <TrackingHistory history={trackingHistory} />
          </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="rounded-lg bg-gray-50 p-3 dark:bg-gray-700/50">
                      ...
                      <div className="text-lg font-semibold text-gray-900 dark:text-white">
                        ${selectedPackage.item_value.toLocaleString()}
                      </div>
                    </div>
                  </div>
                </div>
