...
export default function SecretPackageManagement() {
  ...
  const mockPackages: FrontendPackage[] = [
    ...
    },
    {
      ...
      itemName: 'Documents',
      itemDescription: 'Legal contracts and certificates',
      itemValue: 500.00,
      status: 'delivered',
    ...
    },
    {
      ...
      itemName: 'Clothing',
      itemDescription: 'Winter jackets and sweaters',
      itemValue: 350.00,
      status: 'pending',
    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        const transformedPackage: FrontendPackage = {
          ...
          itemName: supabasePackage.item_name || '',
          itemDescription: supabasePackage.item_description || '',
          itemValue: supabasePackage.item_value || 0,
